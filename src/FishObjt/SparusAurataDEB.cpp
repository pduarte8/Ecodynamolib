...
TSparusAurataDEB::TSparusAurataDEB(TEcoDynClass* APEcoDynClass, char* className)
...
void TSparusAurataDEB::ReadParameters()
{
    // Read in the parameters
    NumberOfParameterRecords = 0;
    //MyPReadWrite = (TReadWrite*)MyPEcoDynClass->OpenParametersFile("TSparusAurataDEB");
...
#else  // __BORLANDC__
        cerr << "TSparusAurataDEB::ReadParameters - Undefined parameters in Fish parameters file" << endl;
#endif  // __BORLANDC__
}

/*
void TSparusAurataDEB::ReadVariables()
{
...
/*void TSparusAurataDEB::PreBuildFish()
{
...
/*
void TSparusAurataDEB::PostBuildFish()
{
    randomize();
