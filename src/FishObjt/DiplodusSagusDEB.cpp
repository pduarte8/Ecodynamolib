...
TDiplodusSargusDEB::TDiplodusSargusDEB(TEcoDynClass* APEcoDynClass, char* className)
...
void TDiplodusSargusDEB::ReadParameters()
{
...
#else  // __BORLANDC__
       cerr << "TDiplodusSargusDEB::ReadParameters - Undefined parameters in Fish parameters file" << endl;
#endif  // __BORLANDC__
}

/*
void TDiplodusSargusDEB::ReadVariables()
{
...
/*void TDiplodusSargusDEB::PreBuildFish()
{
...
/*void TDiplodusSargusDEB::PostBuildFish()
{
    randomize();
