...
TDynamicPhytoplankton::TDynamicPhytoplankton(TEcoDynClass* APEcoDynClass,
...
#else  // __BORLANDC__
						cerr << "TDynamicPhytoplankton::TDynamicPhytoplankton - Undefined object" << endl;
#endif  // __BORLANDC__
        }
...
TDynamicPhytoplankton::~TDynamicPhytoplankton()
{
    freeMemory();
}

void TDynamicPhytoplankton::freeMemory()
{
}


double TDynamicPhytoplankton::GetParameterValue(char* MyParameter)
{
  double value;
    ...
    // parameters from TDynamicPhytoplankton
...
bool TDynamicPhytoplankton::SetParameterValue(char* MyParameter, double value)
{
  bool rc = true;
  int j;
...
// AP, 2007.07.12
bool TDynamicPhytoplankton::SaveParameters()
{
...
void TDynamicPhytoplankton :: Production()
{
