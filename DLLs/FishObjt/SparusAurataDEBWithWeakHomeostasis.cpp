...
TSparusAurataDEBWithWeakHomeostasis::TSparusAurataDEBWithWeakHomeostasis(TEcoDynClass* APEcoDynClass, char* className)
							 :	TFishWithWeakHomeostasis(APEcoDynClass, className)
{
   strcpy(MyFishName,"SparusAurata");
   BuildFish();
}


void TSparusAurataDEBWithWeakHomeostasis::ReadParameters()
{
...
#else  // __BORLANDC__
        cerr << "TSparusAurataDEBWithWeakHomeostasis::ReadParameters - Undefined parameters in Fish parameters file" << endl;
#endif  // __BORLANDC__
}

/*
void TSparusAurataDEBWithWeakHomeostasis::ReadVariables()
{
...
/*void TSparusAurataDEBWithWeakHomeostasis::PreBuildFish()
{
...
/*
void TSparusAurataDEBWithWeakHomeostasis::PostBuildFish()
{
    randomize();
